...
export function BookingSidebarCard() {
  ...
  return (
    <div className="sticky top-[100px] rounded-2xl border border-gray-200 bg-white shadow-md overflow-hidden">
      ...
      <div className="p-6 flex flex-col gap-4">
        ...
        <div className="text-center">
          ...
          <p className="text-[13px] text-gray-500 leading-snug">{config.subtext}</p>
        </div>

        {/* Destination list */}
        <ul className="flex flex-col gap-2">
          {config.destinations.map((dest) => (
            <li key={dest} className="flex items-center gap-2 text-[14px] text-gray-700">
              <span className="flex-shrink-0 w-5 h-5 rounded-full bg-[#FEC601]/20 flex items-center justify-center">
                <svg
                  className="w-3 h-3 text-[#265EA6]"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2.5"
                  viewBox="0 0 24 24"
        ...
        <Link
          ...
          className="flex items-center justify-center gap-2 rounded-xl bg-[#FEC601] px-5 py-3 text-[15px] font-bold text-white shadow-sm"
        >
          Book Taxi Now
          <svg
            className="w-4 h-4"
        ...
        <div className="flex items-center justify-between pt-1 border-t border-gray-100">
          ...
          >
            <svg className="w-3.5 h-3.5 text-primary_color" fill="currentColor" viewBox="0 0 24 24">
